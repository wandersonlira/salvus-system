...
// ============= FIND-ALL ============
router.get('/produtos', ProdutoRepository.findAll);
...
// });
// ============= FIND-BY-ID ============
router.get('/produtos/:id', ProdutoRepository.findById);
...
// });
// // ============= SAVE ============
router.post('/produtos', ProdutoRepository.create);
...
// });
// // ============= UPDATE ============
router.put('/produtos/:id', ProdutoRepository.update);
...
// });
// // ============= DELETE ============
router.delete('/produtos/:id', ProdutoRepository.delete);
